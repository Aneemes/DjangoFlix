...
from .models import TVShowProxy,TVShowSeasonProxy, PublishStateOptions
...
class TVShowProxyModelTestCase(TestCase):
    def create_show_with_seasons(self):
        ...
        season_1 = TVShowSeasonProxy.objects.create(title='The Office Series Season 1', parent=the_office, order=1, state=PublishStateOptions.PUBLISH,)
    ...
    def setUp(self):
        ...
        obj_b = TVShowProxy.objects.create(title='This is my title',
    ...
    def test_video_playlist_ids_property(self):
        ...
        actual_ids = list(TVShowProxy.objects.all().filter(video=self.video_a)
    ...
    def test_tv_show_draft_case(self):
        ...
        # qs = TVShowProxy.objects.filter(state='DR')
